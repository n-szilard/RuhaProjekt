...
namespace RuhaProjekt
{
    public class TopWear : Clothing
    {
        ...
        public TopWear(string brand, string size, string color, int price, string type, string fit, string neckline) : base(brand, size, color, price)
        {
            Type = type;
            Fit = fit;
            Neckline = neckline;
